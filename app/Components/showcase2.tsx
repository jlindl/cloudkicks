...
const Showcase2: React.FC = () => {
  ...
  return (
    <section ref={sectionRef} className="w-full bg-black px-6 py-24 text-white font-inter font-bold relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl grid items-stretch gap-16 lg:grid-cols-2 relative z-10">

        <ScrollReveal direction="left" distance={60} duration={0.9} blur className="h-full">
          <motion.div
            animate={{ y: [0, -10, 0] }}
            transition={{ repeat: Infinity, duration: 6, ease: "easeInOut" }}
            className="relative h-full flex flex-col justify-center p-10 md:p-14 rounded-[2rem] bg-white/5 backdrop-blur-2xl border border-white/10 shadow-[0_0_80px_rgba(255,255,255,0.03)] overflow-hidden group"
          >
            ...
            <div className="relative z-10 text-neutral-400 leading-relaxed text-lg lg:text-xl font-light tracking-wide max-w-md space-y-4">
              <p>Big silhouette. Soft landing.</p>
              <p>Comfort that carries through the day.</p>
              <p>Slip in. Step out.</p>
            </div>
        ...
        <ScrollReveal direction="right" distance={60} duration={0.9} delay={0.15} className="relative w-full h-full min-h-[400px]">
