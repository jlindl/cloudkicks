...
export default async function ShopPage() {
    ...
    return (
        <div className="min-h-screen bg-black font-inter text-white pt-20 pb-20 relative overflow-hidden">
            ...
            <div className="mx-auto max-w-7xl px-6 relative z-10">
                ...
                <div className="flex flex-col items-center justify-center text-center mt-6 mb-12 min-h-[20vh]">
                    <ScrollReveal duration={1} distance={40}>
                        <div className="inline-flex items-center gap-3 px-3 py-1.5 border border-white/10 bg-white/5 backdrop-blur-md rounded-full mb-6">
                    ...
                    <ScrollReveal duration={1} delay={0.2} distance={30}>
                        <h1 className="text-5xl md:text-7xl lg:text-8xl font-kanit font-black leading-[0.85] tracking-tighter uppercase relative group">
                    ...
                    <ScrollReveal duration={1} delay={0.4} distance={20}>
                        <p className="mt-6 text-neutral-400 max-w-2xl mx-auto text-base md:text-lg font-light tracking-wide">
                            This release. This moment. <br className="hidden md:block" />
                            Retired when it’s done.
                        </p>
                    </ScrollReveal>
                </div>
